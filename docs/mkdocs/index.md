...
- **What can the model do?** [How the encoding model works](how-encoding-works.md)
  and [Feature families](FAQ/feature-families.md)
  cover what you can predict and how the analysis is set up.
